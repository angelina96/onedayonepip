...
<form class='login-form' method="POST">
  ...
  <div class="flex-row">
    <label class="lf--label" for="password">
      <svg x="0px" y="0px" class="col-shahrul">
        <g>
          <path fill="#B1B7C4" d="M6,2L6,2c0-1.1-1-2-2.1-2H2.1C1,0,0,0.9,0,2.1v0.8C0,4.1,1,5,2.1,5h1.7C5,5,6,4.1,6,2.9V3h5v1h1V3h1v2h1V3h1 V2H6z M5.1,2.9c0,0.7-0.6,1.2-1.3,1.2H2.1c-0.7,0-1.3-0.6-1.3-1.2V2.1c0-0.7,0.6-1.2,1.3-1.2h1.7c0.7,0,1.3,0.6,1.3,1.2V2.9z"/>
        </g>
      </svg>
    </label>
    <input id="password" class='lf--input' placeholder='Password' type='password' name="userid">
  </div>
  <input class='lf--submit' type='submit' value='ACCESS' name="addAduan">
</form>
<!--<a class='lf--forgot' href='#'>Forgot password?</a>-->
  ...
  if (isset($_POST['addAduan'])) {
		...
		echo"<script>document.location.href='bmb.php';</script>";
			...
			echo"<script>document.location.href='../check';</script>";
			}
  }
  ?> 