...
$i = 0;
//ambik data PO
$data = mysqli_query($conn,"SELECT * FROM wd W,affiliate A, userpro U  WHERE  W.id=A.userid AND U.id=A.userid AND W.created_date LIKE '$paydate%' AND W.id!='' AND W.typ='USDT' ORDER BY U.akaunb ASC") or die(mysqli_error($conn));
